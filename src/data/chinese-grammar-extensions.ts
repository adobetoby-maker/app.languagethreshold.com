...
export const CHINESE_GRAMMAR_EXTENSIONS: CoreGrammarPattern[] = [
  ...
  { id: "zh-le", name: "Completed action with 了", meaning: "mark a completed or changed situation", pattern: "verb + 了", examples: ["我打了电话。", "他来了。"], phase: 1 },
  ...
  { id: "zh-want", name: "Want and intention", meaning: "express desire or plan", pattern: "想 / 要 + verb", examples: ["我想学中文。", "我要去医院。"], phase: 1 },
  { id: "zh-can", name: "Ability and permission", meaning: "say can, know how, or may", pattern: "会 / 能 / 可以 + verb", examples: ["我会说一点中文。", "可以坐这里吗？"], phase: 1 },
