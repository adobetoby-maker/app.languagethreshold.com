...
export const FREQUENCY_WORDS: FrequencyWordEntry[] = [
  {
    ...
    translations: {
      ...
      Chinese: { word: "能", example: "我能说中文。", exampleTranslation: "I can speak Chinese." },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "用", example: "我用电话。", exampleTranslation: "I use the phone." },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "做", example: "今天做什么？", exampleTranslation: "What are you doing today?" },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "来", example: "明天能来吗？", exampleTranslation: "Can you come tomorrow?" },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "去", example: "我去商店。", exampleTranslation: "I'm going to the store." },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "说", example: "你想说什么？", exampleTranslation: "What do you want to say?" },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "学", example: "我想学中文。", exampleTranslation: "I want to learn Chinese." },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "告诉", example: "告诉我发生了什么。", exampleTranslation: "Tell me what happened." },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "说", example: "我会说一点中文。", exampleTranslation: "I speak a little Chinese." },
