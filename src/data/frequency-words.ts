...
export const FREQUENCY_WORDS: FrequencyWordEntry[] = [
  {
    ...
    translations: {
      ...
      Chinese: { word: "能", example: "Néng shuō zhōngwén.", exampleTranslation: "I can speak Chinese." },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "用", example: "Wǒ yòng diànhuà.", exampleTranslation: "I use the phone." },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "做", example: "Jīntiān zuò shénme?", exampleTranslation: "What are you doing today?" },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "来", example: "Míngtiān néng lái ma?", exampleTranslation: "Can you come tomorrow?" },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "去", example: "Wǒ qù shāngdiàn.", exampleTranslation: "I'm going to the store." },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "说", example: "Nǐ xiǎng shuō shénme?", exampleTranslation: "What do you want to say?" },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "学", example: "Wǒ xiǎng xué zhōngwén.", exampleTranslation: "I want to learn Chinese." },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "告诉", example: "Gàosu wǒ fāshēng le shénme.", exampleTranslation: "Tell me what happened." },
  ...
  },
  {
    ...
    translations: {
      ...
      Chinese: { word: "说", example: "Wǒ huì shuō yìdiǎn zhōngwén.", exampleTranslation: "I speak a little Chinese." },
